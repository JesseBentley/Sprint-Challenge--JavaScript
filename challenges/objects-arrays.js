...
tyrannosaurus.roar = function () {
  return 'Bock bock... oh wait wrong animal RAWR'
}
...
for(let i = 0; i < zooAnimals.length; i++){
  animalNames.push(`${zooAnimals[i].animal_name.toLowerCase()}, ${zooAnimals[i].scientific_name.toLowerCase()}`)
}
...
zooAnimals.reduce((sum, sumAnimals) => {
  return populationTotal.push(sumAnimals.population);
});
